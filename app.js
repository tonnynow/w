const commands = [
  ...
  ["ilv", "Дублирует указанный текст до 100 раз подряд", ".ilv 5 Я тебя люблю", 0],
  ...
  ["love", "Красивая анимация сердец с указанием текста", ".love я тебя люблю", 0],
  ["fire", "Анимация огня с указанием текста в конце", ".fire крутяк", 0],
  ["boom", "Анимация взрыва с указанием текста в конце", ".boom тест", 0],
  ...
  ["reaction", "Накручивает реакции на пост или сообщение в чате", ".reaction", 1],
  ["crypto", "Показывает актуальную информацию о криптовалютах и перевод в валюту", ".crypto", 0],
  ["tempmail", "Выдаёт временную почту, действующую 5 минут", ".tempmail", 0],
  ["iss", "Показывает текущее местоположение Международной космической станции", ".iss", 0],
  ["style", "Позволяет выбрать один из 23 стилей скобок для времени в нике", ".style", 0],
  ...
  ["krek", "Крашнет телегу у собеседника", ".krek", 1],
